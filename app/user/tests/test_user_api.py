...
# API url to create tokens
TOKEN_URL = reverse('user:token')
# API url to test un-auth methods
...
class PublicUserApiTests(TestCase):
    """Test the public features of the API- do not require authentication"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test POST is not allowed for the me endpoint. Only PUT."""
